...
def parse_args():
    ...
    parser.add_argument('--data_json', '-dj', default=r'E:\Github\PyRetri-master\main\data_json\Precision_75_1_query.json', type=str, help='json file for dataset to be extracted')
    parser.add_argument('--save_path', '-sp', default=r'E:\Github\PyRetri-master\data\features\PrecisionTest\75_1GeM\query', type=str, help='save path for features')
    parser.add_argument('--config_file', '-cfg', default=r'E:\Github\PyRetri-master\configs\cifar-10.yaml', metavar='FILE', type=str, help='path to config file')
    parser.add_argument('--save_interval', '-si', default=15000, type=int, help='number of features saved in one part file')
